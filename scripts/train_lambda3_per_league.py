# -*- coding: utf-8 -*-
"""
Treina λ3 (correlação) por liga mantendo os teus λ_home/λ_away marginais.
Espera um CSV com: league_id, goals_home, goals_away, lambda_home, lambda_away
Guarda em: models/bivar_lambda3.json
"""
